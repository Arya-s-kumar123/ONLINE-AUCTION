            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="slider_text text-center">
                            ...
                            <span class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">online</span>
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">auction  2025</h3>
                        ...
                        <div class="single_propram">
                            <div class="inner_wrap">
                                ...
                                <div class="porgram_top">
                                    ...
                                    <h4 class=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">12 Feb 2025</h4>
                                </div>
                        ...
                        <div class="single_propram">
                            <div class="inner_wrap">
                                ...
                                <div class="porgram_top">
                                    ...
                                    <h4 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay=".4s">12 Feb 2025</h4>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="footer_widget">
                            <div class="address_details text-center">
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">12 Feb, 2025</h4>
