                ...
                <div class="flex-between">
                    <div class="card-number flex-vertical-center flex-fill">
                        <div class="card-number-field flex-vertical-center flex-fill">
                            ...
                            <input class="numbers" type="number" min="1" max="9999" placeholder="0000" maxlength="4" required>-
                            <input class="numbers" type="number" placeholder="0000" maxlength="4" required>-
                            <input class="numbers" type="number" placeholder="0000" maxlength="4" required>-
                            <input class="numbers" type="number" placeholder="0000" required data-bound="carddigits_mock" data-def="0000" maxlength="4">
                        </div>
