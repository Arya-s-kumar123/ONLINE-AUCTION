...
if (isset($_REQUEST['add'])) {
    ...
    if (move_uploaded_file($tempname, '../img/' . $filename)) {
        ...
        if ($fetchData['cnt'] > 0) {
            ...
            $qryAddProduct = "INSERT INTO `products`(`product_name`, `brand`, `image`, `description`, `price`,`sid`,`product_code`)
                             VALUES ('$product_name', '$brand', '$filename', '$description', '$price','$uid','$product_code')";
            // echo $qryAddProduct;
...
<body style="background-color:black;">
    ...
    <div style="margin:40px 400px; ">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" placeholder="Product Code" name="product_code" maxlength="10" class="form-control one">
